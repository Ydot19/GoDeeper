...
func main() {
	...
	then select will take the <-messages case with that value. If
	not it will immediately take the default case.
	*/
	select {
	case msg := <-messages:
	...
	/**A non-blocking send works similarly. Here msg cannot be sent to
